...
{# fun Fl_SVG_Image_New_WithData as svgImageNewWithData' { unsafeToCString `T.Text' , unsafeToCString `T.Text' } -> `Ptr ()' id #}
svgImageNew :: T.Text -> T.Text -> IO (Either UnknownError (Ref SVGImage))
svgImageNew fileName' svgData' = do
  ptr <- svgImageNewWithData' fileName' svgData'
